#ifndef MATRIX_MULTIPLY_SHARED_CUH
#define MATRIX_MULTIPLY_SHARED_CUH

#include <cuda_runtime.h>
#include <cuda_runtime_api.h>

// Kernel for matrix multiplication using shared memory and block tiling
...
double matrixMultiplyShared(float *A, float *B, float *C, int M, int N, int K, int BLOCK_SIZE, float *executionTime) {
    float *d_A, *d_B, *d_C;
...
#endif // MATRIX_MULTIPLY_SHARED_CUH
